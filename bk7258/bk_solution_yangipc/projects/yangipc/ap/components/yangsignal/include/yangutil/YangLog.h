...
#define yang_error( fmt, ...) __android_log_print(ANDROID_LOG_ERROR,"metaRTC",fmt, ##__VA_ARGS__)
	...
	#define yang_fatal( fmt, ...) BK_LOGE("metaRTC",fmt, ##__VA_ARGS__)

	#define yang_warn( fmt, ...) BK_LOGW("metaRTC",fmt, ##__VA_ARGS__)
	#define yang_info( fmt, ...) BK_LOGI("metaRTC",fmt, ##__VA_ARGS__)
	#define yang_debug( fmt, ...) BK_LOGD("metaRTC",fmt, ##__VA_ARGS__)


	#define yang_debug2( fmt, ...) BK_LOGD("metaRTC",fmt, ##__VA_ARGS__)
	#define yang_info2( fmt, ...) BK_LOGI("metaRTC",fmt, ##__VA_ARGS__)
