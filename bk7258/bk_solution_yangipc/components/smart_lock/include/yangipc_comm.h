#ifndef __YANGIPC_COMM_H__
#define __YANGIPC_COMM_H__

#define UDP_SDP_LOCAL_PORT              (10000)
#define UDP_SDP_REMOTE_PORT             (52110)

#define YANGIPC_CMD_PORT               (7100)

#define YANGIPC_UDP_IMG_PORT           (7180)
#define YANGIPC_UDP_AUD_PORT           (7170)

#define YANGIPC_TCP_IMG_PORT           (7150)
#define YANGIPC_TCP_AUD_PORT           (7140)

#define YANGIPC_UDP_NETWORK_MAX_SIZE   (1472)
#define YANGIPC_TCP_NETWORK_MAX_SIZE   (1460)
#define YANGIPC_NETWORK_MAX_SIZE       (1024)
...
#define DEVICE_RESPONSE_SIZE (YANGIPC_NETWORK_MAX_SIZE - sizeof(db_evt_head_t))
...
typedef enum
{
    YANGIPC_SERVICE_NONE = 0,
    YANGIPC_SERVICE_P2P_CS2 = 1,
    YANGIPC_SERVICE_LAN_UDP = 2,
    YANGIPC_SERVICE_LAN_TCP = 3
} yangipc_service_t;
...
typedef struct
{
    int (*init)(void *param);
    void (*deinit)(void);
    int (*camera_state_changed)(yangipc_state_t state);
    int (*audio_state_changed)(yangipc_state_t state);
    const void *camera_transfer_cb;
    const void *audio_transfer_cb;
} yangipc_service_interface_t;
